    ...
    <div class="form-row mt-4 addable-list-dakramen fixed-height-scrollable">
        <div class="list-item">
            <div class="col-12 mb-3">
                <select name="openingen[dakramen][eigenschappen][]" class="picky-animation__select form-control has-custom-input">
            ...
            <div class="col-12 mb-4">
                <input type="text" class="d-none w-100 my-3 custom-input" name="custom_<?php echo $subcategorie->getId()?>">
            </div>
        </div>
    </div>
</div>