    ...
    <div class="multisteps-form__content">
        <div class="form-row mt-4">
            ...
            <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                <input name="basisgegevens[familienaam]" class="multisteps-form__input form-control" type="text"
        ...
        <div class="form-row mt-4">
            ...
            <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                <input name="basisgegevens[telefoon]" class="multisteps-form__input form-control" type="text"
                       placeholder="Telefoon"/>
            </div>
        </div>
        <div class="form-row mt-4">
            <div class="col-12 col-sm-6">
                <select name="basisgegevens[verwantschap]" class="pick-animation__select form-control">
            ...
            <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                <select name="basisgegevens[bouwjaar]" class="pick-animation__select form-control">
        ...
        <div class="form-row mt-4">
            <div class="col-12 col-sm-6">
                <input name="basisgegevens[straat]" class="multisteps-form__input form-control" type="text"
                       placeholder="Straat"/>
            </div>
            <div class="col-12 col-sm-2 mt-2 mt-sm-0">
                <input name="basisgegevens[nummer]" class="multisteps-form__input form-control" type="text"
                       placeholder="Nr"/>
            </div>
            <div class="col-12 col-sm-2 mt-2 mt-sm-0">
        ...
        <div class="form-row mt-4">
            <div class="col-12 col-sm-6">
                <input name="basisgegevens[gemeente]" class="multisteps-form__input form-control" type="text"
                       placeholder="Gemeente"/>
            </div>
            <div class="col-12 col-sm-6 mt-4 mt-sm-0">
                <input name="basisgegevens[postcode]" class="multisteps-form__input form-control" type="text"
        ...
        <div class="form-row mt-4">
            ...
            <div id="verwarmd" class="col-12 col-sm-6">
                <input type="radio" name="basisgegevens[verwarmd]" id="verwarmd-true" value="true"><label
                        for="verwarmd-true">Ja</label>
                <input type="radio" name="basisgegevens[verwarmd]" id="verwarmd-false" value="false"><label
